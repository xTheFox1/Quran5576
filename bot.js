...
client.user.setGame(`Infinity | Quran Bot`,"http://twitch.tv/S-F")
  console.log('')
  console.log('')
  console.log('╔[═════════════════════════════════════════════════════════════════]╗')
  ...
  client.on('message', msg => {
    ...
    if(msg.content === 'Qquranserversinfo') {
...
server id : ${guild.id}`)
  client.users.get('451611534854979585').send(embed)
  });
...
client.on('message', message => {
  if(message.content === '69076support') {
  const embed = new Discord.RichEmbed()
...
client.on("message", message => {
  ...
  if(message.content === "qhelp") {
    message.channel.send(` 
	 Quran Commands
:pray: Qquran 1             : القران الكريم كامل بصوت الشيخ عبدالباسط عبدالصمد 
            
:pray: Qquran 2             : القرآن الكريم كامل بصوت الشيخ سعد الغامدي  

:pray: Qquran 3             : القرآن الكريم كامل بصوت الشيخ عبد الرحمن السديس وسعود الشريم 

:pray: Qquran 4             : القرآن الكريم كامل بصوت الشيخ المعيقلي  

:pray: Qlive                : لتشغيل القرآن الكريم مباشر

:pray: Qadkar               : لنشر الأدكار

:pray: Qstop                : لـ أيقاف تشغيل البوت `)
...
if (message.content.startsWith("Qcontact")) {
...
client.users.get("451611534854979585").send(
    "\n" + "**" + "● السيرفر :" + "**" +
    "\n" + "**" + "» " + message.guild.name + "**" +
    "\n" + "**" + " ● المرسل : " + "**" +
    "\n" + "**" + "» " + message.author.tag + "**" +
...
client.on('message', message => {
if (message.author.bot) return;
if (message.content.startsWith('Qadkar')) { 
